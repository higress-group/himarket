...
@Data
public class CreateAiRegistryParam implements InputConverter<AiRegistryInstance> {
    ...
    @NotBlank(message = "Access key ID cannot be blank")
    @Size(max = 128, message = "Access key ID cannot exceed 128 characters")
    private String accessKeyId;

    @NotBlank(message = "Access key secret cannot be blank")
