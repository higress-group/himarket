...
public class ApsaraStackGatewayClient extends GatewayClient {
    ...
    /** 构建ApsaraStack请求头 根据配置设置必要的业务头信息 */
    ...
    public CreateAppResponse CreateApp(
            String gwInstanceId, String appName, String key, Integer authType) {
        try {
    ...
    /** 更新应用（Consumer） */
    public ModifyAppResponse ModifyApp(
            String gwInstanceId,
            String appId,
            String appName,
            String key,
    ...
    public ListAppsByGwInstanceIdResponse ListAppsByGwInstanceId(
        ...
        try {
            ...
            return client.listAppsByGwInstanceIdWithOptions(
                    request, buildRequestHeaders(), runtime);
        } catch (Exception e) {
    ...
    public AddMcpServerConsumersResponse AddMcpServerConsumers(
            String gwInstanceId, String mcpServerName, java.util.List<String> consumers) {
        try {
    ...
    public DeleteMcpServerConsumersResponse DeleteMcpServerConsumers(
        ...
        try {
            ...
            return client.deleteMcpServerConsumersWithOptions(
                    request, buildRequestHeaders(), runtime);
        } catch (Exception e) {
