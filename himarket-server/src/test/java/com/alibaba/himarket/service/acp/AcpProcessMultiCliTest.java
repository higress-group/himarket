...
/**
 * 集成测试：验证 AcpProcess 能通过 ACP 协议成功连接多种 CLI 工具。
 *
 ...
 */
class AcpProcessMultiCliTest {

    private static final Logger log = LoggerFactory.getLogger(AcpProcessMultiCliTest.class);
    ...
    void testAcpInitialize(CliDef cli) throws Exception {
        ...
        AcpProcess process =
                new AcpProcess(cli.command(), cli.args(), cwd.toString(), Collections.emptyMap());
