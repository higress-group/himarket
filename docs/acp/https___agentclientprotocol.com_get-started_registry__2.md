...
`0.16.0`](https://github.com/zed-industries/claude-code-acp)[## Codex CLI

`0.9.2`](https://github.com/zed-industries/codex-acp)
...
`0.27.3`](https://github.com/google-gemini/gemini-cli)[## GitHub Copilot

`1.425.0`](https://github.com/github/copilot-language-server-release)[## Junie

`704.1.0`](https://github.com/jetbrains-junie/junie)[## Kimi CLI

`1.9.0`](https://github.com/MoonshotAI/kimi-cli)[## Mistral Vibe

`2.0.2`](https://github.com/mistralai/mistral-vibe)[## OpenCode

`1.1.53`](https://github.com/sst/opencode)
...
`0.10.0`](https://github.com/QwenLM/qwen-code)
