...
function Square(props: { activeType: string }) {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        // 根据排序选项设置排序参数
        const sortWithOrder = sortOption !== 'default' ? sortOption + ",desc" : undefined;
    ...
    fetchProducts();
  }, [activeType, activeCategory, sortOption]);
  ...
  }, [activeType, activeCategory, currentPage, hasMore, loadingMore, PAGE_SIZE, sortOption]);
          ...
          <div className="flex-1 flex flex-col relative">
            ...
            <div className="flex items-center justify-between mb-2 pl-4 pr-4">
              ...
              >
                ...
                <Select.Option value="usageCount">按调用量排序</Select.Option>
                <Select.Option value="subscriptionCount">按订阅数排序</Select.Option>
                <Select.Option value="likesCount">按点赞数排序</Select.Option>
              </Select>
              ...
              <Input
                  ...
                  className="w-80 rounded-xl ml-4"
                  style={{
                    backgroundColor: "rgba(255, 255, 255, 0.6)",
                    backdropFilter: "blur(10px)",
                  }}
